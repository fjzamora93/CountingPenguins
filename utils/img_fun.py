...
def crop_tile_into_subrecortes(
    ...
    Nota: El cálculo de coordenadas geográficas incluye un ajuste para manejar el flip vertical del polo sur.
    ...
    with rasterio.open(tiff_file) as src:
        for upper in range(0, HEIGHT, step):
            for left in range(0, WIDTH, step):
                ...
                # Ajustar el flip vertical para el polo sur
                max_y_flip = max_y + (upper - lower) * transform.e
                ...
                filtered_coords = coords_df[
                    ...
                    (coords_df["y_center"] >= max_y_flip) & (coords_df["y_center"] <= max_y)
                ]
                ...
                filename = f"{imagename}_{upper}_{left}.jpg"
